...
export const EditableField = ({ label, value, path, onUpdate, type = "text", options = [] }) => {
...
export const EditableArrayField = ({ label, values, path, onUpdate }) => {
...
export const EditableObjectField = ({ label, value, path, onUpdate, fields }) => {
...
export const EditableComplexArrayField = ({ label, items, path, onUpdate, fields }) => {
