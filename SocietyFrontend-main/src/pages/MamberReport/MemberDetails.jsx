...
//     // Get filtered fields based on category and view type WITH OCCUPATION FILTERING
...
//             return filtered; // No occupation filtering for "all" category
//         }
...
//             });
//             return filterFieldsByOccupation(filtered, selectedMember);
//         }
...
//         // Specific category - only apply occupation filtering for professional details
...
//         // For other categories, no occupation filtering needed
...
//     const occupationType = getOccupationType(selectedMember);
...
//                         {/* Add Occupation Chip */}
//                         <Chip
//                             label={`Occupation: ${occupationType ? occupationType.toUpperCase() : "Not specified"}`}
//                             color="primary"
//                             variant="outlined"
//                         />
//                         <Chip
...
//                             <Chip label={Object.keys(FIELD_MAP).length - Object.keys(FIELD_MAP).filter(k => k.startsWith('professionalDetails.')).length} size="small" variant="outlined" />
//                         </Box>
//                     } />
